...
public class CustomerRepository extends SimpleRepository<StaffEntity>{

	public List<StaffEntity> findAll(Map<String,Object> properties,
		...
		List<StaffEntity> resutls =  findAll(SQL);
		return resutls;
	}

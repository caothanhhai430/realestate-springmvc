	...
	<input type="hidden" id="id-customer-trans">
		...
		<div class="modal-content" style="overflow-wrap: break-word;">
			<div>
				...
				<button id="btn-addCareNote" class="ColVis_Button ColVis_MasterButton btn btn-white btn-info btn-bold"><span>
			...
			<button class="btn btn-blue">Xem thêm</button>
			
		</div>
			<div style="height: 100px;"></div>
			<div>
				<span style="font-size: 35px;">Dẫn đi ăn
				<button id="btn-addTourNote" class="ColVis_Button ColVis_MasterButton btn btn-white btn-info btn-bold"><span>
					<i class="fa fa-plus"></i></span></button>
				</span>
